      ...
      <div className="mx-6 md:mx-20 lg:mx-40">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
          <div>
            <h3 className="text-lg font-semibold mb-4">
              Unified Resource Management Institute for Logistics and Analytics
              (URMILA)
            </h3>
            <p className="text-gray-400">
              We offer cutting-edge supply chain management courses to help
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button
                  onClick={() =>
                    (window.location.href = "https://recruiter.urmila.academy")
                  }
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  Recruiter Login
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">
                  DLF Cybercity, Gurugram (HR), India
                </span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:support@urmila.academy"
                  className="text-gray-400 hover:text-white transition-colors"
                >
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-sm text-gray-400">
            © 2024 URMILA. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
